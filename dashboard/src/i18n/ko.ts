const ko = {
  ...
  addGoalCreateDirectDesc: "목표만 추가하고 나중에 스팩/분해를 진행합니다",
  addGoalWithSpec: "스팩 생성 후 추가",
  addGoalWithSpecDesc: "AI가 구조화된 스팩을 자동 생성합니다 (1~2분 소요)",
  addGoalSuccess: "목표가 추가되었습니다!",
  specGeneratingInCard: "스팩 생성 중",
  specGenerateComplete: "스팩 생성이 완료되었습니다!",
  specGenerateFailed: "스팩 생성에 실패했습니다. 다시 시도해주세요.",
  tasks: "태스크",
  decompose: "분해",
  decomposed: "분해됨",
  reDecompose: "재분해",
  reDecomposeConfirm: "기존 태스크 {count}개를 삭제하고 재분해합니다. 계속하시겠습니까?",
  reDecomposeConfirmWithDone: "기존 태스크 {count}개 (완료 {done}개 포함)를 모두 삭제하고 재분해합니다. 계속하시겠습니까?",
  reDecomposeSuccess: "기존 태스크를 삭제하고 재분해 완료!",
  decomposing: "분해 중...",
  ...
  gitModeLocalOnlyDesc: "에이전트가 작업 완료 후 메인 브랜치에 자동으로 반영합니다. 외부 서버에 전송하지 않습니다.",
  gitModeBranchOnly: "브랜치 분리",
  gitModeBranchOnlyDesc: "에이전트별 별도 브랜치에 저장합니다. 나중에 직접 확인 후 합칠 수 있습니다.",
  gitModePR: "PR 리뷰",
  gitModePRDesc: "GitHub에 PR을 자동 생성합니다. 코드 리뷰 후 반영할 수 있습니다. (GitHub 연결 필요)",
  gitModeMainDirect: "즉시 배포",
  gitModeMainDirectDesc: "메인 브랜치에 반영하고 GitHub에 바로 전송합니다. (GitHub 연결 필요)",
  gitModeRecommended: "추천",
  gitModeAutoMergeNote: "모든 모드에서 에이전트는 독립된 작업 공간(워크트리)에서 안전하게 작업합니다. '자동 반영' 모드에서는 작업 완료 시 메인 브랜치에 자동으로 합쳐집니다.",
  branchSectionTitle: "미반영 브랜치 ({{count}}개)",
  branchDesc: "에이전트가 작업했지만 메인 브랜치에 아직 합쳐지지 않은 브랜치입니다.",
  branchMergeAll: "에이전트에게 합치기 맡기기",
  branchMerging: "에이전트 작업 중...",
  branchMergeAgentWorking: "{{agent}} 에이전트가 브랜치를 분석하고 합치는 중입니다. 충돌이 있으면 자동으로 해결합니다.",
  branchMergeAgentDone: "모든 브랜치를 메인에 합쳤습니다",
  branchMergePartial: "{{merged}}개 합침, {{remaining}}개는 추가 확인이 필요합니다",
  branchMergeError: "브랜치 합치기에 실패했습니다",
  branchDeleteAll: "모두 삭제",
  branchConfirmDelete: "정말 삭제",
  branchDeleting: "삭제 중...",
  branchDeleteSuccess: "{{count}}개 브랜치를 삭제했습니다",
  branchDeleteError: "브랜치 삭제에 실패했습니다",
  ...
  // Goal Spec (구조화된 기획)
  specGuideTitle: "구조화된 스펙",
  specGuideBody: "목표의 'View Spec'을 클릭하면 PRD, 기능명세, 유저플로우, 수락기준을 AI가 자동 생성합니다. 스펙 품질이 높을수록 태스크 분해와 에이전트 결과물이 좋아집니다.",
  specGenerate: "스펙 생성",
  specGenerating: "생성 중...",
  specCloseBlocked: "스펙 생성 중에는 닫을 수 없습니다",
  specView: "스펙 보기",
  specEdit: "편집",
  specSave: "저장",
  specCancel: "취소",
  specRegenerate: "재생성",
  specPrdSummary: "PRD 요약",
  specBackground: "배경",
  specObjective: "핵심 목표",
  specScope: "범위",
  ...
  specEmpty: "아직 스펙이 없습니다 — 생성하면 태스크 분해 품질이 크게 향상됩니다.",
  specEmptyHint: "AI가 목표를 분석해 PRD, 기능명세, 유저플로우, 수락기준을 자동 생성합니다.",
  specGeneratingDesc: "AI가 목표를 분석하고 구조화된 스펙을 생성하고 있습니다...",
  specGeneratingHint: "모달을 닫아도 백그라운드에서 생성이 계속됩니다.",
