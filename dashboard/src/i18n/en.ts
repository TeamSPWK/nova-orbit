const en = {
  ...
  addGoalCreateDirectDesc: "Add goal only — configure spec/decompose later",
  addGoalWithSpec: "Create with Spec",
  addGoalWithSpecDesc: "AI generates a structured spec automatically (1-2 min)",
  addGoalSuccess: "Goal added!",
  specGeneratingInCard: "Generating spec",
  specGenerateComplete: "Spec generation complete!",
  specGenerateFailed: "Spec generation failed. Please try again.",
  tasks: "Tasks",
  decompose: "Decompose",
